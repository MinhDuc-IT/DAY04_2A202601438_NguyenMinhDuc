...
from .paper_summary.tool import summarize_paper
from .compare_papers.tool import compare_papers
from .extract_paper_insights.tool import extract_paper_insights
...
TOOL_FUNCTIONS = {
    ...
    "extract_paper_insights": extract_paper_insights,
}
